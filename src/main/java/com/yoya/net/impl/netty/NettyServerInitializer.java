 ...
 *
 */
final class NettyServerInitializer extends ChannelInitializer<SocketChannel>{
	...
	protected void initChannel( SocketChannel ch ) throws Exception{
		ch.pipeline().addLast( new NettyServerHandler( _SSL_CTX ) );

//		ChannelPipeline cp = ch.pipeline();
//		if( null != this._SSL_CTX ){
//			cp.addLast( this._SSL_CTX.newHandler( ch.alloc() ) );
//		}
